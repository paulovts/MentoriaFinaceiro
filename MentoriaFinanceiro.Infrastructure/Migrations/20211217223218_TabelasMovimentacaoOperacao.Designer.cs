...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MentoriaFinanceiro.API.Models.Movimentacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MentoriaFinanceiro.API.Models.Operacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MentoriaFinanceiro.API.Models.Movimentacao", b =>
                {
                    b.HasOne("MentoriaFinanceiro.API.Models.Conta", "Conta")
                        .WithOne("Movimentacao")
                        .HasForeignKey("MentoriaFinanceiro.API.Models.Movimentacao", "ContaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MentoriaFinanceiro.API.Models.Operacao", "Operacao")
                        .WithOne("Movimentacao")
                        .HasForeignKey("MentoriaFinanceiro.API.Models.Movimentacao", "OperacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
