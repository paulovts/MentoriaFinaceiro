...
namespace DesafioMentoria.API.Migrations
{
    ...
    [Migration("20211217223218_TabelasMovimentacaoOperacao")]
    partial class TabelasMovimentacaoOperacao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DesafioMentoria.API.Models.Conta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DesafioMentoria.API.Models.Movimentacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DesafioMentoria.API.Models.Operacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("tb_opercao","financeiro");
                });
            ...
            modelBuilder.Entity("DesafioMentoria.API.Models.Conta", b =>
                {
                    b.HasOne("DesafioMentoria.API.Models.Pessoa", "Pessoa")
                        .WithOne("Conta")
                        .HasForeignKey("DesafioMentoria.API.Models.Conta", "PessoaId")
            ...
            modelBuilder.Entity("DesafioMentoria.API.Models.Movimentacao", b =>
                {
                    b.HasOne("DesafioMentoria.API.Models.Conta", "Conta")
                        .WithOne("Movimentacao")
                        .HasForeignKey("DesafioMentoria.API.Models.Movimentacao", "ContaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DesafioMentoria.API.Models.Operacao", "Operacao")
                        .WithOne("Movimentacao")
                        .HasForeignKey("DesafioMentoria.API.Models.Movimentacao", "OperacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
