...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DesafioMentoria.Domain.Entities.Conta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DesafioMentoria.Domain.Entities.Movimentacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DesafioMentoria.Domain.Entities.Operacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DesafioMentoria.Domain.Entities.Pessoa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DesafioMentoria.Domain.Entities.Conta", b =>
                {
                    b.HasOne("DesafioMentoria.Domain.Entities.Pessoa", "Pessoa")
                        .WithOne("Conta")
                        .HasForeignKey("DesafioMentoria.Domain.Entities.Conta", "PessoaId")
            ...
            modelBuilder.Entity("DesafioMentoria.Domain.Entities.Movimentacao", b =>
                {
                    b.HasOne("DesafioMentoria.Domain.Entities.Conta", "Conta")
                        .WithOne("Movimentacao")
                        .HasForeignKey("DesafioMentoria.Domain.Entities.Movimentacao", "ContaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DesafioMentoria.Domain.Entities.Operacao", "Operacao")
                        .WithOne("Movimentacao")
                        .HasForeignKey("DesafioMentoria.Domain.Entities.Movimentacao", "OperacaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
